...
if ~os.path.isfile(PATH_DATA_2 + 'correlations/monthly_correlations_z50_SPoV_enso_' + str(iter) +'.nc4'):
	...
	for i in np.arange(0, 7):
		FILE = np.load(PATH_DATA_2 + 'z50_PV_conditioned_ENSO_' + month[i] + '.npz')
		#test correlation
		...
		correl_WPV_LN[i] = TestCorrelation(FILE['var2'],  FILE['var3'],
						   FILE['var7'], FILE['var3'])
		correl_WPV[i] = TestCorrelation(FILE['var5'], FILE['var3'], FILE['var7'], FILE['var3'])
		correl_SPV[i] = TestCorrelation(FILE['var4'], FILE['var3'], FILE['var6'], FILE['var3'])
	...
	ds.to_netcdf(PATH_DATA_2 + 'correlations/monthly_correlations_z50_SPoV_enso_' + str(iter) + '.nc4')
if ~os.path.isfile(PATH_DATA_2 + 'correlations/seasonal_correlations_z50_SPoV_enso_' + str(iter) +'.nc4'):
	...
	for i in np.arange(0, 5):
		FILE = np.load(PATH_DATA_2 + 'z50_PV_conditioned_ENSO_' + seas[i] + '.npz')
		#test correlation
		correl_SPV_EN[i] = TestCorrelation(FILE['var1'],  FILE['var3'],
						   FILE['var4'], FILE['var3'])
		correl_SPV_LN[i] = TestCorrelation(FILE['var1'],  FILE['var3'],
	...
	ds.to_netcdf(PATH_DATA_2 + 'correlations/seasonal_correlations_z50_SPoV_enso_' + str(iter) +'.nc4')
