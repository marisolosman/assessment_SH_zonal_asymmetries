...
for i in np.arange(7):
	...
	div_SPV_EN = calc.divergence(px_SPV_EN, py_SPV_EN, dx, dy)
	...
	div_WPV_LN = calc.divergence(px_WPV_LN, py_WPV_LN, dx, dy)
	...
	div_SPV_LN = calc.divergence(px_SPV_LN, py_SPV_LN, dx, dy)
...
#	plots.PlotPoVCompositesENSOZPF(var, hgt.latitude, hgt.longitude, tit, filename)
	var ={'z1': div_SPV_all, 'px1': px_SPV, 'py1': py_SPV,
	      'z2': div_SPV_EN, 'px2': px_SPV_EN, 'py2': py_SPV_EN,
	      'z3': div_SPV_LN, 'px3': px_SPV_LN, 'py3': py_SPV_LN,
	      'z4': div_WPV_all, 'px4': px_WPV, 'py4': py_WPV,
	      'z5': div_WPV_EN, 'px5': px_WPV_EN, 'py5': py_WPV_EN,
	      'z6': div_WPV_LN, 'px6': px_WPV_LN, 'py6': py_WPV_LN}
	tit = 'Composites Plumb Fluxes and divergence (*1e6) 50hPa SPoV Conditioned - ENSO - ' + month[i]
	filename = FIG_PATH + 'div_pf_50_composites_SPoV_' + month[i] +'_ENSO_q.png'
	plots.PlotPoVCompositesENSOdivPF(var, lat, hgt.longitude, tit, filename)
