...
for i in np.arange(0, 7):
	...
	tit = 'Composites linear term Plumb Fluxes and its divergence (1e7) at 50hPa - ' + month[i]
	filename = FIG_PATH + 'z50_pf_composites_' + month[i] +'_lt.png'
	...
	tit = 'Composites non-linear term Plumb fluxes and its divergence (1e7) at 50hPa - ' + month[i]
	filename = FIG_PATH + 'z50_pf_composites_' + month[i] +'_nlt.png'
	plots.PlotCompositesdivPF(var, hgt.latitude, hgt.longitude, tit, filename)
	...
	tit = 'Composites EM Plumb fluxes and its divergence (1e7) at 50hPa - ' + month[i]
	filename = FIG_PATH + 'z50_pf_composites_' + month[i] +'_em.png'
	plots.PlotCompositesdivPF(var, hgt.latitude, hgt.longitude, tit, filename)
