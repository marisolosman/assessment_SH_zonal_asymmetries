...
lista = xr.open_dataset(RUTA + 'seasonal_correlations_z200_SPoV_enso_polar_10k.nc4')
...
df.to_csv(RUTA + "percentile_seasonal_correlations_composites_z200_SPoV_enso.csv")

lista = xr.open_dataset(RUTA + 'monthly_correlations_z200_SPoV_enso_polar_10k.nc4')
...
df.to_csv(RUTA + "percentile_monthly_correlations_composites_z200_SPoV_enso.csv")
