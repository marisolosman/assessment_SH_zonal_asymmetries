...
FILE_HGT_S4 = 'fogt/monthly_winds50_aug_feb.nc4'
...
for i in np.arange(0, 7):
	...
	tit = 'Composites S4 U 50hPa Conditioned - ENSO - ' + month[i]
	filename = FIG_PATH + 'U50_composites_SPoV2_' + month[i] +'_ENSO.png'
...
for i in np.arange(0, 5):
	...
	tit = 'Composites S4 U 50hPa Conditioned - ENSO - ' + seas[i]
	filename = FIG_PATH + 'U50_composites_SPoV2_' + seas[i] +'_ENSO_new.png'
	plots.PlotPoVCompositesENSOU(var_SPV_all - var_normal, var_WPV_all - var_normal,
				    var_SPV_EN - var_normal, var_WPV_EN - var_normal,
				    var_SPV_LN - var_normal, var_WPV_LN - var_normal,
				    winds.latitude, winds.longitude,
