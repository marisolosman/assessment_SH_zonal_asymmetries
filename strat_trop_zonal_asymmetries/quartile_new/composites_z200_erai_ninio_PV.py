...
for i in np.arange(0, 7):
	...
	tit = 'Composites ERAI Z* 200hPa Conditioned - SPoV - ' + month[i]
	filename = FIG_PATH + 'z200_erai_composites_ENSO_' + month[i] +'_SPoV.png'
...
for i in np.arange(0, 5):
	...
	tit = 'Composites ERAI Z* 200hPa Conditioned - SPoV - ' + seas[i]
	filename = FIG_PATH + 'z200_erai_composites_ENSO_' + seas[i] +'_SPoV.png'
	plots.PlotEnsoCompositesPoV(var_ninio_all - var_normal, var_ninia_all- var_normal,
				    var_ninio_WPV - var_normal, var_ninia_WPV - var_normal,
				    var_ninio_SPV - var_normal, var_ninia_SPV - var_normal,
				    hgt.latitude, hgt.longitude, tit, filename)
