...
index_normal_all = np.logical_and(ninio34.ninio34_index < ninio34.ninio34_index.quantile(0.75, dim='dim_0',
											 interpolation='linear'),
				  ninio34.ninio34_index > ninio34.ninio34_index.quantile(0.25, dim='dim_0',
											 interpolation='linear'))
...
hgt = hgt.sel(**{'latitude': slice(-50, -80), 'longitude': slice(165, 355)}).compute()
# get gradient
...
for i in np.arange(0, 7):
	...
	var_ninio_all = np.array([val_min[i, index_ninio_normal], lat_min[i, index_ninio_all],
				  lon_min[i, index_ninio_normal], val_max[i, index_ninio_all],
				  lat_max[i, index_ninio_normal], lon_max[i, index_ninio_all]])
	...
	var_ninia_all =  np.array([val_min[i, index_ninia_normal], lat_min[i, index_ninia_all],
				  lon_min[i, index_ninia_normal], val_max[i, index_ninia_all],
				  lat_max[i, index_ninia_normal], lon_max[i, index_ninia_all]])
