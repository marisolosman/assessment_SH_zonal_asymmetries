...
if ~os.path.isfile(PATH_DATA_2 + 'correlations/monthly_correlations_enso_SPoV_' + str(iter) +'.nc4'):
	...
	ds.to_netcdf(PATH_DATA_2 + 'correlations/monthly_correlations_enso_SPoV_' + str(iter) + '.nc4')
if ~os.path.isfile(PATH_DATA_2 + 'correlations/seasonal_correlations_enso_SPoV_' + str(iter) +'.nc4'):
	...
	ds.to_netcdf(PATH_DATA_2 + 'correlations/seasonal_correlations_enso_SPoV_' + str(iter) +'.nc4')
