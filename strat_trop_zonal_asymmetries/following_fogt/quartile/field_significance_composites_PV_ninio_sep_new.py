...
lista = xr.open_mfdataset(RUTA + "correlations/seasonal*_SPoV_enso*_sep_new.nc4", chunks=None)
lista.to_netcdf(RUTA + 'seasonal_correlations_z200_SPoV_enso_polar_10k_sep_new.nc4')

file = RUTA + "seasonal_correlations_SPoV_enso_polar_sep_new.nc4"
...
df.to_csv(RUTA + "percentile_seasonal_correlations_composites_SPoV_enso_sep_new.csv")

lista = xr.open_mfdataset(RUTA + "correlations/monthly*_SPoV_enso*_sep_new.nc4", chunks=70000)
lista.to_netcdf(RUTA + 'monthly_correlations_z200_SPoV_enso_polar_10k_sep_new.nc4')
file = RUTA + "monthly_correlations_SPoV_enso_polar_sep_new.nc4"
correlations = xr.open_dataset(file)
...
df.to_csv(RUTA + "percentile_monthly_correlations_composites_SPoV_enso_sep_new.csv")
