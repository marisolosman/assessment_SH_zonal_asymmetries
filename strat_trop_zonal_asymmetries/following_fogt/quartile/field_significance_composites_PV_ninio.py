...
lista = xr.open_mfdataset(RUTA + "correlations/seasonal*_SPoV_enso*_q.nc4", chunks=None)
lista.to_netcdf(RUTA + 'seasonal_correlations_z200_SPoV_enso_polar_10k_q.nc4')

file = RUTA + "seasonal_correlations_SPoV_enso_polar_q.nc4"
...
df.to_csv(RUTA + "percentile_seasonal_correlations_composites_SPoV_enso_q.csv")

lista = xr.open_mfdataset(RUTA + "correlations/monthly*_SPoV_enso*_q.nc4", chunks=70000)
lista.to_netcdf(RUTA + 'monthly_correlations_z200_SPoV_enso_polar_10k_q.nc4')
...
df.to_csv(RUTA + "percentile_monthly_correlations_composites_SPoV_enso_q.csv")
