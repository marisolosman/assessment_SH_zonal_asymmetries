...
for i in np.arange(0, 7):
	...
	np.savez(PATH_DATA_2 + 'z50_conditioned_' + month[i] + '_q.npz', var1=hgt.z.values[i, index_ninio_all.values, :, :], var2=hgt.z.values[i, index_normal_all.values, :, :], var3=hgt.z.values[i, index_ninia_all.values, :, :], var4=hgt_WPV.z.values[i, index_ninio_WPV.values, :, :], var5=hgt_WPV.z.values[i, index_normal_WPV.values, :, :], var6=hgt_WPV.z.values[i, index_ninia_WPV.values, :, :], var7=hgt_SPV.z.values[i, index_ninio_SPV.values, :, :], var8=hgt_SPV.z.values[i, index_normal_SPV.values, :, :], var9=hgt_SPV.z.values[i, index_ninia_SPV.values, :, :])
...
ds.to_netcdf(PATH_DATA_2 + 'monthly_correlations_z50_enso_SPoV_polar_q.nc4')
...
for i in np.arange(0, 5):
	...
	np.savez(PATH_DATA_2 + 'z50_conditioned_' + seas[i] + '_q.npz', var1=hgt_s.z.values[index_ninio_all.values, :, :], var2=hgt_s.z.values[index_normal_all.values, :, :], var3=hgt_s.z.values[index_ninia_all.values, :, :], var4=hgt_s_WPV.z.values[index_ninio_WPV.values, :, :], var5=hgt_s_WPV.z.values[index_normal_WPV.values, :, :], var6=hgt_s_WPV.z.values[index_ninia_WPV.values, :, :], var7=hgt_s_SPV.z.values[index_ninio_SPV.values, :, :], var8=hgt_s_SPV.z.values[index_normal_SPV.values, :, :], var9=hgt_s_SPV.z.values[index_ninia_SPV.values, :, :])
...
ds.to_netcdf(PATH_DATA_2 + 'seasonal_correlations_z50_enso_SPoV_polar_q.nc4')
