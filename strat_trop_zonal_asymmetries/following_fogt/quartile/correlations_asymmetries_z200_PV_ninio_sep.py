...
if ~os.path.isfile(PATH_DATA_2 + 'correlations/monthly_correlations_SPoV_enso_' + str(iter) +'_sep_q.nc4'):
	...
	for i in np.arange(0, 7):
		FILE = np.load(PATH_DATA_2 + 'z200_PV_conditioned_ENSO_' + month[i] + '_sep_q.npz')
		#test correlation
	...
	ds.to_netcdf(PATH_DATA_2 + 'correlations/monthly_correlations_SPoV_enso_' + str(iter) + '_sep_q.nc4')
if ~os.path.isfile(PATH_DATA_2 + 'correlations/seasonal_correlations_SPoV_enso_' + str(iter) +'_sep_q.nc4'):
	...
	for i in np.arange(0, 5):
		FILE = np.load(PATH_DATA_2 + 'z200_PV_conditioned_ENSO_' + seas[i] + '_sep_q.npz')
		#test correlation
		correl_SPV_EN[i] = TestCorrelation(FILE['var1'],  FILE['var3'],
						   FILE['var4'], FILE['var6'])
		correl_SPV_LN[i] = TestCorrelation(FILE['var1'],  FILE['var3'],
	...
	ds.to_netcdf(PATH_DATA_2 + 'correlations/seasonal_correlations_SPoV_enso_' + str(iter) +'_sep_q.nc4')
