...
if ~os.path.isfile(PATH_DATA_2 + 'correlations/monthly_correlations_z200_enso_SPoV_' + str(iter) +'_q.nc4'):
	...
	for i in np.arange(0, 7):
		FILE = np.load(PATH_DATA_2 + 'z200_conditioned_' + month[i] + '_q.npz')
		#test correlation
	...
	ds.to_netcdf(PATH_DATA_2 + 'correlations/monthly_correlations_z200_enso_SPoV_' + str(iter) + '_q.nc4')
if ~os.path.isfile(PATH_DATA_2 + 'correlations/seasonal_correlations_z200_enso_SPoV_' + str(iter) +'_q.nc4'):
	...
	for i in np.arange(0, 5):
		FILE = np.load(PATH_DATA_2 + 'z200_conditioned_' + seas[i] + '_q.npz')
		#test correlation
		correl_ninio_WPV[i] = TestCorrelation(FILE['var1'], FILE['var2'], FILE['var4'], FILE['var5'])
		correl_ninia_WPV[i] = TestCorrelation(FILE['var3'], FILE['var2'], FILE['var6'], FILE['var5'])
		correl_ninio_SPV[i] = TestCorrelation(FILE['var1'], FILE['var2'], FILE['var7'], FILE['var8'])
	...
	ds.to_netcdf(PATH_DATA_2 + 'correlations/seasonal_correlations_z200_enso_SPoV_' + str(iter) +'_q.nc4')
