...
for i in np.arange(0,7):
	...
	tit = 'HGT 50hPa Composites differences EN+LN Years - ' + month[i]
	filename = './figures_decile/z50_composites_sum_NINIO_' + month[i] +'.png'
...
for i in np.arange(0,5):
	...
	tit = 'HGT 50hPa Composites differences EN+LN Years - ' + seas[i]
	filename = './figures_decile/z50_composites_sum_NINIO_' + seas[i] +'.png'
	plots.PlotCompDiff(var, ds.latitude, ds.longitude, tit, filename)
