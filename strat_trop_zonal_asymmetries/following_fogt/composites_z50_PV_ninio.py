...
for i in np.arange(0, 7):
	...
	tit = 'Composites S4 Z* 50hPa Strong SPoV - Weak SPoV Conditioned - ENSO - ' + month[i]
	filename = FIG_PATH + 'z50_composites_SPoV_' + month[i] +'_ENSO.png'
...
for i in np.arange(0, 5):
	...
	filename = FIG_PATH + 'z50_composites_SPoV_' + seas[i] +'_ENSO.png'
	plots.PlotPoVCompositesDiffENSO(var_SPV_all-var_WPV_all, var_SPV_EN - var_WPV_EN,
				    var_SPV_LN - var_WPV_LN, hgt.latitude, hgt.longitude,
				    tit, filename)
