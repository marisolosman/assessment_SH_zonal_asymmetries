...
for i in np.arange(0, 7):
	...
	np.savez(PATH_DATA_2 + 'z200_conditioned_' + month[i] + '.npz', var1=hgt.z.values[i, index_ninio_all.values, :, :], var2=hgt.z.values[i, index_normal_all.values, :, :], var3=hgt.z.values[i, index_ninia_all.values, :, :], var4=hgt_WPV.z.values[i, index_ninio_WPV.values, :, :], var5=hgt_WPV.z.values[i, index_normal_WPV.values, :, :], var6=hgt_WPV.z.values[i, index_ninia_WPV.values, :, :], var7=hgt_SPV.z.values[i, index_ninio_SPV.values, :, :], var8=hgt_SPV.z.values[i, index_normal_SPV.values, :, :], var9=hgt_SPV.z.values[i, index_ninia_SPV.values, :, :])
...
#testear si los campos son distintos:
	...
	asimmetry_ninio_WPV[i, :] = ComputeAsymmetry(hgt.z.values[i, :, :, :]-np.nanmean(hgt.z.values[i, :, :, :], axis=0), var_ninio_WPV - var_normal_WPV)
	asimmetry_ninia_WPV[i, :] = ComputeAsymmetry(hgt.z.values[i, :, :, :]-np.nanmean(hgt.z.values[i, :, :, :], axis=0), var_ninia_WPV - var_normal_WPV)
	asimmetry_ninio_SPV[i, :] = ComputeAsymmetry(hgt.z.values[i, :, :, :]-np.nanmean(hgt.z.values[i, :, :, :], axis=0), var_ninio_SPV - var_normal_SPV)
	asimmetry_ninia_SPV[i, :] = ComputeAsymmetry(hgt.z.values[i, :, :, :]-np.nanmean(hgt.z.values[i, :, :, :], axis=0), var_ninia_SPV - var_normal_SPV)
	asimmetry_ninio_all[i, :] = ComputeAsymmetry(hgt.z.values[i, :, :, :]-np.nanmean(hgt.z.values[i, :, :, :], axis=0), var_ninio_all - var_normal_all)
	asimmetry_ninia_all[i, :] = ComputeAsymmetry(hgt.z.values[i, :, :, :]-np.nanmean(hgt.z.values[i, :, :, :], axis=0), var_ninia_all - var_normal_all)
...
ds.to_netcdf(PATH_DATA_2 + 'monthly_asimmetric_index_enso_SPoV_polar.nc4')
ds = xr.Dataset({'correl_ninio_WPV': (['month'], correl_ninio_WPV),
		 ...
		 coords={'month': (['month'], month)})
ds.to_netcdf(PATH_DATA_2 + 'monthly_correlations_enso_SPoV_polar.nc4')
...
for i in np.arange(0, 5):
	...
	asimmetry_ninio_WPV[i, :] = ComputeAsymmetry(hgt_s.z.values-np.nanmean(hgt_s.z.values, axis=0), var_ninio_WPV - var_normal_WPV)
	asimmetry_ninia_WPV[i, :] = ComputeAsymmetry(hgt_s.z.values-np.nanmean(hgt_s.z.values, axis=0), var_ninia_WPV - var_normal_WPV)
	asimmetry_ninio_SPV[i, :] = ComputeAsymmetry(hgt_s.z.values-np.nanmean(hgt_s.z.values, axis=0), var_ninio_SPV - var_normal_SPV)
	asimmetry_ninia_SPV[i, :] = ComputeAsymmetry(hgt_s.z.values-np.nanmean(hgt_s.z.values, axis=0), var_ninia_SPV - var_normal_SPV)
	asimmetry_ninio_all[i, :] = ComputeAsymmetry(hgt_s.z.values-np.nanmean(hgt_s.z.values, axis=0), var_ninio_all - var_normal_all)
	asimmetry_ninia_all[i, :] = ComputeAsymmetry(hgt_s.z.values-np.nanmean(hgt_s.z.values, axis=0), var_ninia_all - var_normal_all)
	#save npz file to compute correlations
	np.savez(PATH_DATA_2 + 'z200_conditioned_' + seas[i] + '.npz', var1=hgt_s.z.values[index_ninio_all.values, :, :], var2=hgt_s.z.values[index_normal_all.values, :, :], var3=hgt_s.z.values[index_ninia_all.values, :, :], var4=hgt_s_WPV.z.values[index_ninio_WPV.values, :, :], var5=hgt_s_WPV.z.values[index_normal_WPV.values, :, :], var6=hgt_s_WPV.z.values[index_ninia_WPV.values, :, :], var7=hgt_s_SPV.z.values[index_ninio_SPV.values, :, :], var8=hgt_s_SPV.z.values[index_normal_SPV.values, :, :], var9=hgt_s_SPV.z.values[index_ninia_SPV.values, :, :])
...
ds.to_netcdf(PATH_DATA_2 + 'seasonal_asimmetric_index_enso_SPoV_polar.nc4')
...
ds = xr.Dataset({'correl_ninio_WPV': (['seas'], correl_ninio_WPV),
		 ...
		 coords={'seas': (['seas'], seas)})
ds.to_netcdf(PATH_DATA_2 + 'seasonal_correlations_enso_SPoV_polar.nc4')
