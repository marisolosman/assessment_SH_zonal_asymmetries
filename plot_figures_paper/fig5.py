...
var_normal = np.mean(hgt.z.values[:, :, :, :], axis=1)
SS_normal = np.var(hgt.z.values[:, :, :, :], axis=1) / nn_index_normal
...
for i in range(6):
	...
	ax[0, i].contour(lon, lat, variable, clevs2, transform=ccrs.PlateCarree(),
			 linewidths=0.4, colors='black')
	barra.set_under(barra(0))
	barra.set_over(barra(barra.N-1))
#	plt.title(titulos[0] + ' - ' + month[i + 1])
#
	#ax = plt.subplot(8, 6, i + 7, projection=proj)
	...
	im = ax[1, i].contourf(lon, lat, M, clevs, transform=ccrs.PlateCarree(),
			 cmap=barra, extend='both', vmin=-60, vmax=60)
	ax[1, i].contour(lon, lat, variable, clevs2, transform=ccrs.PlateCarree(),
			 linewidths=0.4, colors='black')
	barra.set_under(barra(0))
	barra.set_over(barra(barra.N-1))
#	plt.title(titulos[1] + ' - ' + month[i + 1])
	
	#ax = plt.subplot(8, 6, i + 13, projection=proj)
	...
	im = ax[2, i].contourf(lon, lat, M, clevs, transform=ccrs.PlateCarree(),
			 cmap=barra, extend='both', vmin=-60, vmax=60)
	ax[2, i].contour(lon, lat, variable, clevs2, transform=ccrs.PlateCarree(),
			 linewidths=0.4, colors='black')

	barra.set_under(barra(0))
	barra.set_over(barra(barra.N-1))
#	plt.title(titulos[2] + ' - ' + month[i + 1])

	#ax = plt.subplot(8, 6, i + 19, projection=proj)
	...
	im = ax[3, i].contourf(lon, lat, M, clevs, transform=ccrs.PlateCarree(),
			 cmap=barra, extend='both', vmin=-60, vmax=60)
	ax[3, i].contour(lon, lat, variable, clevs2, transform=ccrs.PlateCarree(),
			 linewidths=0.4, colors='black')

	barra.set_under(barra(0))
	barra.set_over(barra(barra.N-1))
#	plt.title(titulos[3] + ' - ' + month[i + 1])

	#ax = plt.subplot(8, 6, i + 25, projection=proj)
	...
	barra.set_under(barra(0))
	barra.set_over(barra(barra.N-1))
	ax[4, i].contour(lon, lat, variable, clevs2, transform=ccrs.PlateCarree(),
			 linewidths=0.4, colors='black')

#	plt.title(titulos[4] + ' - ' + month[i + 1])

	#ax = plt.subplot(8, 6, i + 31, projection=proj)
	...
	barra.set_under(barra(0))
	barra.set_over(barra(barra.N-1))
	ax[5, i].contour(lon, lat, variable, clevs2, transform=ccrs.PlateCarree(),
			 linewidths=0.4, colors='black')

#	plt.title(titulos[5] + ' - ' + month[i + 1])

	#ax = plt.subplot(8, 6, i + 37, projection=proj)
	...
	barra.set_under(barra(0))
	barra.set_over(barra(barra.N-1))
	ax[6, i].contour(lon, lat, variable, clevs2, transform=ccrs.PlateCarree(),
			 linewidths=0.4, colors='black')

#	plt.title(titulos[6] + ' - ' + month[i + 1])

	#ax = plt.subplot(8, 6, i + 43, projection=proj)
	...
	barra.set_under(barra(0))
	barra.set_over(barra(barra.N-1))
	ax[7, i].contour(lon, lat, variable, clevs2, transform=ccrs.PlateCarree(),
			 linewidths=0.4, colors='black')
