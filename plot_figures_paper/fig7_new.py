...
var_normal = np.mean(hgt.Harmonics.values[:, :, index_normal, :, :], axis=2)
SS_normal = np.var(hgt.Harmonics.values[:, :, index_normal, :, :], axis=2) / nn_index_normal
...
tit = 'Composites S4 Z* 200hPa Wave-2'
filename = FIG_PATH + 'z200_W2_composites_ENSO_SPoV_2.eps'
...
for i in range(4):
	...
	ax[i, 0].contour(lon, lat, hgt_clim.Harmonics[harmonic + 1, i +1, :, :], clevs2, transform=ccrs.PlateCarree(),
	...
	ax[i, 1].contourf(lon, lat, M, clevs, transform=ccrs.PlateCarree(),
			 cmap=barra, extend='both', vmin=-60, vmax=60)
	ax[i, 1].contour(lon, lat, hgt_clim.Harmonics[harmonic + 1, i +1, :, :], clevs2, transform=ccrs.PlateCarree(),
			 linewidths=0.4, colors='black')
	barra.set_under(barra(0))
	barra.set_over(barra(barra.N-1))
	...
	ax[i, 2].contourf(lon, lat, M, clevs, transform=ccrs.PlateCarree(),
			 cmap=barra, extend='both', vmin=-60, vmax=60)
	ax[i, 2].contour(lon, lat, hgt_clim.Harmonics[harmonic + 1, i +1, :, :], clevs2, transform=ccrs.PlateCarree(),
			linewidths=0.4, colors='black')
	barra.set_under(barra(0))
	barra.set_over(barra(barra.N-1))
	...
	barra.set_under(barra(0))
	barra.set_over(barra(barra.N-1))
	ax[i, 3].contour(lon, lat, hgt_clim.Harmonics[harmonic + 1, i +1, :, :], clevs2, transform=ccrs.PlateCarree(),
			linewidths=0.4, colors='black')
pad = 5
...
tit = 'Composites S4 Z* 200hPa Wave-2'
filename = FIG_PATH + 'z200_W2_composites_ENSO_SPoV_3.eps'
...
for i in range(4):
	...
	ax[i, 0].set_boundary(circle, transform=ax[i, 0].transAxes)
	ax[i, 0].coastlines()
	variable = var_ninio_WPV[harmonic + 1, i + 1, :, :] - var_ninio_SPV[harmonic + 1, i + 1, :, :]
	variable_std = variable / np.sqrt(SS_ninio_WPV[harmonic + 1, i + 1, :, :] + SS_ninio_SPV[harmonic + 1, i + 1, :, :])
	...
	ax[i, 1].set_boundary(circle, transform=ax[i, 1].transAxes)
	ax[i, 1].coastlines()
	variable = var_ninia_WPV[harmonic + 1, i + 1, :, :] - var_ninia_SPV[harmonic + 1, i + 1, :, :]
	variable_std = variable / np.sqrt(SS_ninia_WPV[harmonic + 1, i + 1, :, :] + SS_ninia_SPV[harmonic + 1, i + 1, :, :])
	...
	ax[i, 2].set_boundary(circle, transform=ax[i, 2].transAxes)
	ax[i, 2].coastlines()
	variable = var_ninio_WPV[harmonic + 1, i + 1, :, :] - var_ninia_WPV[harmonic + 1, i + 1, :, :]
	variable_std = variable / np.sqrt(SS_ninio_WPV[harmonic + 1, i + 1, :, :] + SS_ninia_WPV[harmonic + 1, i + 1, :, :])
	...
	ax[i, 3].set_boundary(circle, transform=ax[i, 3].transAxes)
	ax[i, 3].coastlines()
	variable = var_ninio_SPV[harmonic + 1, i + 1, :, :] - var_ninia_SPV[harmonic + 1, i + 1, :, :]
	variable_std = variable / np.sqrt(SS_ninio_SPV[harmonic + 1, i + 1, :, :] + SS_ninia_SPV[harmonic + 1, i + 1, :, :])
