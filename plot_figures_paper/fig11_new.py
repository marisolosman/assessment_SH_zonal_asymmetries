...
if not(os.path.isfile('pf_oct_50.npz')):
	...
	print(f.keys())
	var_l_50 = f['arr_0'].flat[0]
	var_nl_50 = f['arr_1'].flat[0]
	var_em_50 = f['arr_2'].flat[0]
...
winds_clm = winds.mean(dim='realiz')
i = 2
if not(os.path.isfile('pf_oct_200.npz')):
	...
	print(f.keys())
	var_l_200 = f['arr_0'].flat[0]
	var_nl_200 = f['arr_1'].flat[0]
	var_em_200 = f['arr_2'].flat[0]


tit = 'Composites EM Plumb fluxes and its divergence - ' + month[i]
filename = FIG_PATH + 'fig_pf_composites_oct_em_11.eps'
...
filename = FIG_PATH + 'fig_pf_composites_oct_lt_s11.eps'
...
filename =  FIG_PATH + 'fig_pf_composites_oct_nlt_s11.eps'
