...
for year in range(1981, 2018):
	...
	initmonth = 8
	initbdate = "%s%02d01"%(year,initmonth)
	if not (os.path.isfile("/storage/silver/acrcc/vg140344/t_S4Hindcasts_monthly_Mlevels_%s.grib"%(initbdate))):
		print ('get data from ', initbdate)
		print ("################################")		
		server.execute({
			'class'   : "od",
			...
			'system'  : "4",
			'grid'    : "128",},
			 "/storage/silver/acrcc/vg140344/t_S4Hindcasts_monthly_Mlevels_%s.grib"%(initbdate))
