...
for i in np.arange(0,7):
	...
	filename = './figures/hgt_200_composites_PV_' + month[i] +'.png'
	...
	filename = './figures/hgt_200_composites_diff_PV_' + month[i] +'.png'
...
for i in np.arange(0, 5):
	...
	filename = './figures/hgt_200_composites_PV_' + seas[i] +'_3.png'
	PlotComposites(var_pos, var_neg, ds.latitude, ds.longitude, tit, filename)
	...
	filename = './figures/hgt_200_composites_diff_PV_' + seas[i] +'.png'
	PlotCompDiff(var, ds.latitude, ds.longitude, tit, filename)
