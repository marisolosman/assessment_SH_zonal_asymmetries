...
index_monthly_upper = PV_EN.PV_mon >= PV_EN.PV_mon.quantile(0.75, dim='dim_0', interpolation='linear')
index_monthly_lower = PV_EN.PV_mon <= PV_EN.PV_mon.quantile(0.25, dim='dim_0', interpolation='linear')
index_monthly_normal = np.logical_and(PV_EN.PV_mon < PV_EN.PV_mon.quantile(0.75, dim='dim_0', interpolation='linear'), PV_EN.PV_mon > PV_EN.PV_mon.quantile(0.25, dim='dim_0', interpolation='linear'))
...
for i in np.arange(0,4):
	...
	filename = './figures/200_RWS_chi_composites_PV_' + month[i] +'_EN.png'
	...
	filename = './figures/200_RWS_chi_composites_diff_PV_' + month[i] +'_EN.png'
...
index_monthly_upper = PV_LN.PV_mon >= PV_LN.PV_mon.quantile(0.75, dim='dim_0', interpolation='linear')
index_monthly_lower = PV_LN.PV_mon <= PV_LN.PV_mon.quantile(0.25, dim='dim_0', interpolation='linear')
index_monthly_normal = np.logical_and(PV_LN.PV_mon < PV_LN.PV_mon.quantile(0.75, dim='dim_0', interpolation='linear'), PV_LN.PV_mon > PV_LN.PV_mon.quantile(0.25, dim='dim_0', interpolation='linear'))
...
for i in np.arange(0,4):
	...
	filename = './figures/200_RWS_chi_composites_PV_' + month[i] +'_LN.png'
	plots.PlotCompositesDivPlumbPV(var_pos, var_neg, uchi_pos, uchi_neg, vchi_pos, vchi_neg,
				     S.latitude.values, S.longitude.values, tit, filename)
	...
	filename = './figures/200_RWS_chi_composites_diff_PV_' + month[i] +'_LN.png'
	plots.PlotCompDivPlumbDiff(var, uchi_1, vchi_1, S.latitude, S.longitude, tit, filename)
...
for i in np.arange(0, 2):
	...
	filename = './figures/200_RWS_chi_composites_PV_' + seas[i] +'_EN.png'
	plots.PlotCompositesDivPlumbPV(var_pos, var_neg, uchi_pos, uchi_neg, vchi_pos, vchi_neg,
				     S.latitude.values, S.longitude.values, tit, filename)
	var = np.mean(S_EN.values[i, index_monthly_upper.values, :, :], axis=0) - np.mean(S_EN.values[i, index_monthly_lower.values, :, :], axis=0)
	uchi_1 = np.mean(uchi_EN.u_chi.values[i, index_monthly_upper.values, :, :], axis=0) - np.mean(uchi_EN.u_chi.values[i, index_monthly_lower.values, :, :], axis=0)
	...
	filename = './figures/200_RWS_chi_composites_diff_PV_' + seas[i] +'_EN.png'
	plots.PlotCompDivPlumbDiff(var, uchi_1, vchi_1, S.latitude, S.longitude, tit, filename)
...
for i in np.arange(0, 2):
	...
	filename = './figures/200_RWS_chi_composites_PV_' + seas[i] +'_LN.png'
	plots.PlotCompositesDivPlumbPV(var_pos, var_neg, uchi_pos, uchi_neg, vchi_pos, vchi_neg,
				     S.latitude.values, S.longitude.values, tit, filename)
	var = np.mean(S_LN.values[i, index_monthly_upper.values, :, :], axis=0) - np.mean(S_LN.values[i, index_monthly_lower.values, :, :], axis=0)
	uchi_1 = np.mean(uchi_LN.u_chi.values[i, index_monthly_upper.values, :, :], axis=0) - np.mean(uchi_LN.u_chi.values[i, index_monthly_lower.values, :, :], axis=0)
	...
	filename = './figures/200_RWS_chi_composites_diff_PV_' + seas[i] +'_LN.png'
	plots.PlotCompDivPlumbDiff(var, uchi_1, vchi_1, S.latitude, S.longitude, tit, filename)
