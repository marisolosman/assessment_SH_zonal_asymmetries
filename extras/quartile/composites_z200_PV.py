...
for i in np.arange(0,7):
	...
	filename = './figures/z_200_composites_PV_' + month[i] +'.png'
	...
	filename = './figures/z_200_composites_diff_PV_' + month[i] +'.png'
...
for i in np.arange(0, 5):
	...
	filename = './figures/z_200_composites_PV_' + seas[i] +'.png'
	PlotZComposites(var_pos, var_neg, ds.latitude, ds.longitude, tit, filename)
	...
	filename = './figures/z_200_composites_diff_PV_' + seas[i] +'.png'
	PlotZCompDiff(var, ds.latitude, ds.longitude, tit, filename)
