...
for i in np.arange(0, 7):
	...
	filename = './figures/z200_composites_diff_NINIO_' + month[i] +'_WPV.png'
...
for i in np.arange(0, 5):
	...
	filename = './figures/z200_composites_diff_NINIO_' + seas[i] +'_WPV.png'
	plots.PlotCompDiff(var, ds.latitude, ds.longitude, tit, filename)
...
for i in np.arange(0, 7):
	...
	filename = './figures/z200_composites_diff_NINIO_' + month[i] +'_SPV.png'
	plots.PlotCompDiff(var, ds.latitude, ds.longitude, tit, filename)
...
for i in np.arange(0, 5):
	...
	filename = './figures/z200_composites_diff_NINIO_' + seas[i] +'_SPV.png'
	plots.PlotCompDiff(var, ds.latitude, ds.longitude, tit, filename)
