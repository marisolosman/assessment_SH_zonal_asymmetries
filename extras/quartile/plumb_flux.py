...
def ComputePlumbFluxes(uclm, vclm, z, zclm, lat, lon):
	...
	[nlats, nlons] = np.shape(z) #get dimensions
	#earth radius
	a = 6400000
	...
	#psi derivatives
	dpsidlon = c_diff(psiaa, lon * 3.14 /180, 1)
	ddpsidlonlon = c_diff(dpsidlon, lon * 3.14, 1)
	dpsidlat = c_diff(psiaa, lat * 3.14 / 180, 0)
	ddpsidlatlat = c_diff(dpsidlat, lat * 3.14 / 180, 0)
	ddpsidlatlon = c_diff(dpsidlat, lon * 3.14 /180, 1)
