...
for i in np.arange(0,7):
	...
	filename = './figures/hgt_50_composites_NINIO_' + month[i] +'.png'
	...
	filename = './figures/hgt_50_composites_diff_NINIO_' + month[i] +'.png'
...
for i in np.arange(0,5):
	...
	filename = './figures/hgt_50_composites_NINIO_' + seas[i] +'.png'
	PlotComposites(var_pos, var_neg, ds.latitude, ds.longitude, tit, filename)
	...
	filename = './figures/hgt_50_composites_diff_NINIO_' + seas[i] +'.png'
	PlotCompDiff(var, ds.latitude, ds.longitude, tit, filename)
