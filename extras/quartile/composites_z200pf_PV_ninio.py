...
for i in np.arange(0,4):
	...
	filename = './figures/z200_plumb_composites_diff_PV_' + month[i] +'_EN.png'
...
for i in np.arange(0,2):
	...
	filename = './figures/z200_plumb_composites_diff_PV_' + seas[i] +'_EN.png'
	plots.PlotCompPlumbDiff(var, px_c, py_c, ds.latitude, ds.longitude, tit, filename)
...
for i in np.arange(0,4):
	...
	filename = './figures/z200_plumb_composites_diff_PV_' + month[i] +'_LN.png'
	plots.PlotCompPlumbDiff(var, px_c, py_c, ds.latitude, ds.longitude, tit, filename)
...
for i in np.arange(0,2):
	...
	filename = './figures/z200_plumb_composites_diff_PV_' + seas[i] +'_LN.png'
	plots.PlotCompPlumbDiff(var, px_c, py_c, ds.latitude, ds.longitude, tit, filename)
