...
index_ninio_upper = ninio34.ninio34_mon >= ninio34.ninio34_mon.quantile(0.75, dim='dim_0', interpolation='linear')
...
for i in np.arange(0,4):
	...
	filename = './figures/hgt_200_plumb_composites_diff_PV_' + month[i] +'_EN.png'
...
for i in np.arange(0,2):
	...
	filename = './figures/hgt_200_plumb_composites_diff_PV_' + seas[i] +'_EN.png'
	plots.PlotCompPlumbDiff(var, px_c, py_c, ds.latitude, ds.longitude, tit, filename)


index_ninio_lower = ninio34.ninio34_mon <= ninio34.ninio34_mon.quantile(0.25, dim='dim_0', interpolation='linear')
...
for i in np.arange(0,4):
	...
	filename = './figures/hgt_200_plumb_composites_diff_PV_' + month[i] +'_LN.png'
	plots.PlotCompPlumbDiff(var, px_c, py_c, ds.latitude, ds.longitude, tit, filename)
...
for i in np.arange(0,2):
	...
	filename = './figures/hgt_200_plumb_composites_diff_PV_' + seas[i] +'_LN.png'
	plots.PlotCompPlumbDiff(var, px_c, py_c, ds.latitude, ds.longitude, tit, filename)
