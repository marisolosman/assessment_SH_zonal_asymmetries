...
for i in np.arange(0,4):
	...
	filename = './figures/hgt_200_plumb_composites_NINIO_' + month[i] +'.png'
	...
	filename = './figures/hgt_200_plumb_composites_diff_NINIO_' + month[i] +'.png'
...
for i in np.arange(0,2):
	...
	filename = './figures/hgt_200_plumb_composites_NINIO_' + seas[i] +'.png'
	plots.PlotCompositesPlumb(var_pos, var_neg,px_pos, px_neg, py_pos, py_neg, ds.latitude,
				 ds.longitude, tit, filename)
	...
	filename = './figures/hgt_200_plumb_composites_diff_NINIO_' + seas[i] +'.png'
	plots.PlotCompPlumbDiff(var, px_c, py_c, ds.latitude, ds.longitude, tit, filename)
