...
for i in np.arange(0,4):
	...
	filename = './figures/200_RWS_chi_composites_diff_NINIO_' + month[i] +'_WPV.png'
...
for i in np.arange(0,4):
	...
	filename = './figures/200_RWS_chi_composites_diff_NINIO_' + month[i] +'_SPV.png'
	plots.PlotCompDivPlumbDiff(var, uchi_1, vchi_1, S.latitude, S.longitude, tit, filename)
...
for i in np.arange(0,2):
	...
	filename = './figures/200_RWS_chi_composites_diff_NINIO_' + seas[i] +'_WPV.png'
	plots.PlotCompDivPlumbDiff(var, uchi_1, vchi_1, S.latitude, S.longitude, tit, filename)
...
for i in np.arange(0,2):
	...
	filename = './figures/200_RWS_chi_composites_diff_NINIO_' + seas[i] +'_SPV.png'
	plots.PlotCompDivPlumbDiff(var, uchi_1, vchi_1, S.latitude, S.longitude, tit, filename)
