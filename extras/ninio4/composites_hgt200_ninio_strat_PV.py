...
for i in np.arange(0,7):
	...
	filename = './figures/hgt_200_composites_sum_NINIO_' + month[i] +'_WPV.png'
...
for i in np.arange(0,5):
	...
	filename = './figures/hgt_200_composites_sum_NINIO_' + seas[i] +'_WPV.png'
	plots.PlotCompDiff(var, ds.latitude, ds.longitude, tit, filename)
...
for i in np.arange(0,7):
	...
	filename = './figures/hgt_200_composites_sum_NINIO_' + month[i] +'_SPV.png'
	plots.PlotCompDiff(var, ds.latitude, ds.longitude, tit, filename)
...
for i in np.arange(0,5):
	...
	filename = './figures/hgt_200_composites_sum_NINIO_' + seas[i] +'_SPV.png'
	plots.PlotCompDiff(var, ds.latitude, ds.longitude, tit, filename)
