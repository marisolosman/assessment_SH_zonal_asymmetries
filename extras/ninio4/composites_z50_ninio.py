...
for i in np.arange(0,7):
	...
	filename = './figures_decile/z50_composites_NINIO_' + month[i] +'.png'
	...
	filename = './figures_decile/z50_composites_diff_NINIO_' + month[i] +'.png'
...
for i in np.arange(0,5):
	...
	filename = './figures_decile/z50_composites_NINIO_' + seas[i] +'.png'
	plots.PlotEnsoComposites(var_pos, var_neg, ds.latitude, ds.longitude, tit, filename)
	...
	filename = './figures_decile/z50_composites_diff_NINIO_' + seas[i] +'.png'
	plots.PlotCompDiff(var, ds.latitude, ds.longitude, tit, filename)
