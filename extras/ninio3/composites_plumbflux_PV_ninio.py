...
index_ninio_upper = ninio3.ninio3_mon >= ninio3.ninio3_mon.quantile(0.90, dim='dim_0', interpolation='linear')
...
index_ninio_lower = ninio3.ninio3_mon <= ninio3.ninio3_mon.quantile(0.10, dim='dim_0', interpolation='linear')
