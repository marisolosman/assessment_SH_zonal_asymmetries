...
ninio3_WPV = ninio3.sel(dim_0=index_PV_upper.values)
...
index_monthly_normal = np.logical_and(ninio3_WPV.ninio3_mon < ninio3_WPV.ninio3_mon.quantile(0.90, dim='dim_0', interpolation='linear'), ninio3_WPV.ninio3_mon > ninio3_WPV.ninio3_mon.quantile(0.10, dim='dim_0', interpolation='linear'))
...
ninio3_SPV = ninio3.sel(dim_0=index_PV_lower.values)
...
index_monthly_normal = np.logical_and(ninio3_SPV.ninio3_mon < ninio3_SPV.ninio3_mon.quantile(0.90, dim='dim_0', interpolation='linear'), ninio3_SPV.ninio3_mon > ninio3_SPV.ninio3_mon.quantile(0.10, dim='dim_0', interpolation='linear'))
