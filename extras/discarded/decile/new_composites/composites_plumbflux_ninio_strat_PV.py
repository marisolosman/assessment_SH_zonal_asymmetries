...
for i in np.arange(0,4):
	...
	filename = './figures/hgt_200_plumb_composites_sum_NINIO_' + month[i] +'_WPV.png'
...
for i in np.arange(0,2):
	...
	filename = './figures/hgt_200_plumb_composites_sum_NINIO_' + seas[i] +'_WPV.png'
	plots.PlotCompPlumbDiff(var, px_c, py_c, ds.latitude, ds.longitude, tit, filename)
...
for i in np.arange(0,4):
	...
	filename = './figures/hgt_200_plumb_composites_sum_NINIO_' + month[i] +'_SPV.png'
	plots.PlotCompPlumbDiff(var, px_c, py_c, ds.latitude, ds.longitude, tit, filename)
...
for i in np.arange(0,2):
	...
	filename = './figures/hgt_200_plumb_composites_sum_NINIO_' + seas[i] +'_SPV.png'
	plots.PlotCompPlumbDiff(var, px_c, py_c, ds.latitude, ds.longitude, tit, filename)
