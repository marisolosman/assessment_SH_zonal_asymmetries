...
for i in np.arange(0, 7):
	...
	tit = 'HGT 50hPa Composites differences SPW-WPV Years - ' + month[i] + '- No ENSO'
	filename = './figures/hgt_50_composites_diff_PV_' + month[i] +'_NoENSO.png'
...
for i in np.arange(0, 5):
	...
	tit = 'HGT 50hPa Composites differences SPV-WPV Years - ' + seas[i] + '- No ENSO'
	filename = './figures/hgt_50_composites_diff_PV_' + seas[i] +'_noEN.png'
	plots.PlotCompDiff(var, ds.latitude, ds.longitude, tit, filename)
