...
for i in np.arange(0,4):
	...
	filename = './figures_decile/hgt_200_plumb_composites_PV_' + month[i] +'.png'
	...
	filename = './figures_decile/hgt_200_plumb_composites_diff_PV_' + month[i] +'.png'
...
for i in np.arange(0,2):
	...
	filename = './figures_decile/hgt_200_plumb_composites_PV_' + seas[i] +'.png'
	plots.PlotCompositesPlumbPV(var_pos, var_neg,px_pos, px_neg, py_pos, py_neg, ds.latitude,
				 ds.longitude, tit, filename)
	...
	filename = './figures_decile/hgt_200_plumb_composites_diff_PV_' + seas[i] +'.png'
	plots.PlotCompPlumbDiff(var, px_c, py_c, ds.latitude, ds.longitude, tit, filename)
