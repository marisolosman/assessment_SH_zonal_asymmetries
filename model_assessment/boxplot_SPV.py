...
for i in np.arange(0, 5):
	aux = PV_erai['z'].resample(time='QS-' + lmonth[i]).mean(dim='time',skipna=True)
	...
	PV_s4_smean = np.nanmean(PV_s4.z.values[i:i + 3, :], axis=0)	
...
# add x-tick labels
plt.savefig('./figures/boxplot_PV_ninio.png', res=400)
...
# add x-tick labels
plt.savefig('./figures/boxplot_PV_ninio_2.png', res=400)
