...
for i in np.arange(0, 5):
	...
	filename = FIG_PATH + 'Composites_NINIO_' + season[i] + '.png'
	...
	filename = FIG_PATH + 'Composites_SPV_' + season[i] + '.png'
