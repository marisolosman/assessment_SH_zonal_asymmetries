...
# add x-tick labels
plt.savefig(FIG_PATH + 'boxplot_SAM_NINIOS_det.png', res=400)
...
# add x-tick labels
plt.savefig(FIG_PATH + 'boxplot_SAM_det.png', res=400)
...
plt.savefig(FIG_PATH + 'regression_sam_enso_det.png', res=400, box_inches='tight'
)
...
plt.savefig(FIG_PATH + 'regression_sam_enso_s4_det.png', res=400,bbox_inches='tight' )
