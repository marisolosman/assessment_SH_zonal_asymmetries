...
for i in np.arange(0, 5):
	...
	filename = FIG_PATH + 'obs_eof_' + season[i] + '_det.png'
	PlotEOF(eofs[0:3, :, :], lat_erai, lon_erai, title, filename)
	filename = FIG_PATH + 'obs_scree_' + season[i] + '_det.png'
	...
	filename = FIG_PATH + 'S4_eof_' + season[i] + '_det.png'
	PlotEOF(eofs_s4[0:3, :, :], lat_s4, lon_s4, title, filename)
	filename = FIG_PATH + 'S4_scree_' + season[i] + '_det.png'
	...
	filename = FIG_PATH + 'S4_realiz_eof_' + season[i] + '_det.png'
	PlotEOF(eofs_s4_realiz[0:3, :, :], lat_s4, lon_s4, title, filename)
	filename = FIG_PATH + 'S4_realiz_scree_' + season[i] + '_det.png'
