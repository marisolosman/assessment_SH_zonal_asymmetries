...
for i in np.arange(0, 5):
	...
	filename = FIG_PATH + 'Composites_z50_NINIO_' + season[i] + '_det.png'
	...
	filename = FIG_PATH + 'Composites_z50_SPV_' + season[i] + '_det.png'
