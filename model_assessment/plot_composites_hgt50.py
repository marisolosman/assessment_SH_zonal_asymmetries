...
ROUTE = '~/datos/data/'
FILE_HGT_S4 = 'monthly_hgt50_aug_feb.nc'
...
for i in np.arange(0, 5):
	...
	filename = './figures/Composites_z50_NINIO_' + season[i] + '.png'
