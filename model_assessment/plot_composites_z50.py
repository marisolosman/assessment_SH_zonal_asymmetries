#plot composites enso phases for ERAI and S4
...
for i in np.arange(0, 5):
	...
	#composites EN-N
	title = 'Composites Z* 50hPa NINIO years - ' + season[i]
	filename = FIG_PATH + 'Composites_z50_NINIO_' + season[i] + '.png'
	...
	#composites LN-N
	title = 'Composites Z* 50hPa NINIA years - ' + season[i]
	filename = FIG_PATH + 'Composites_z50_NINIA_' + season[i] + '.png'
	model = hgt_s4_LN - hgt_s4_N
	obs = hgt_erai_LN - hgt_erai_N
	PlotComposites(model, lat_s4, lon_s4, obs, lat_erai, lon_erai, title, filename)
	#composites EN-LN
	title = 'Composites Z* 50hPa NINIO-NINIA years - ' + season[i]
	filename = FIG_PATH + 'Composites_z50_ENSO_' + season[i] + '.png'
	model = hgt_s4_EN - hgt_s4_LN
	obs = hgt_erai_EN - hgt_erai_LN
	PlotComposites(model, lat_s4, lon_s4, obs, lat_erai, lon_erai, title, filename)
	#composites SSPV
	title = 'Composites Z* 50hPa Strong SPV years - ' + season[i]
	filename = FIG_PATH + 'Composites_z50_SSPV_' + season[i] + '.png'
	model = hgt_s4_SSPV - hgt_s4_NSPV
	obs = hgt_erai_SSPV - hgt_erai_NSPV
	PlotComposites(model, lat_s4, lon_s4, obs, lat_erai, lon_erai, title, filename)
	#composites WSPV
	title = 'Composites Z* 50hPa Weak SPV years - ' + season[i]
	filename = FIG_PATH + 'Composites_z50_WSPV_' + season[i] + '.png'
	model = hgt_s4_WSPV - hgt_s4_NSPV
	obs = hgt_erai_WSPV - hgt_erai_NSPV
	PlotComposites(model, lat_s4, lon_s4, obs, lat_erai, lon_erai, title, filename)
	#composites SSPV - WsPV
	title = 'Composites Z* 50hPa Strong-Weak SPV years - ' + season[i]
	filename = FIG_PATH + 'Composites_z50_SPV_' + season[i] + '.png'
