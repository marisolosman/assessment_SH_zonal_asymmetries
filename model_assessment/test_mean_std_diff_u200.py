...
winds_erai_mean = winds_erai.sel(**{'time':slice('1981-08-01', '2018-02-01')}).groupby('time.month').mean(dim='time')
winds_erai_sd = winds_erai.sel(**{'time':slice('1981-08-01', '2018-02-01')}).groupby('time.month').std(dim='time')
...
for i in np.arange(0, 5):
	...
	filename = FIG_PATH + 'u200_bias_' + season[i] + '.png'
	#interpolation
